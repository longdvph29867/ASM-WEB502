...
const DetailPage = () => {
  ...
  const fetchProduct = async () => {
    try {
      showSpinner();
      const API = `${ApiUrls.API_URL}/products/${id}`;
        ...
        <div className="lg:flex">
          <div className="w-full lg:w-[50%] ">
            <div className="relative pb-[100%]">
              ...
              {/* <button
        class="w-9 h-9 flex items-center justify-center rounded-full bg-white text-neutral-700 dark:text-slate-200 absolute right-3 top-3 ">
          ...
          <path d="M12.62 20.81C12.28 20.93 11.72 20.93 11.38 20.81C8.48 19.82 2 15.69 2 8.68998C2 5.59998 4.49 3.09998 7.56 3.09998C9.38 3.09998 10.99 3.97998 12 5.33998C13.01 3.97998 14.63 3.09998 16.44 3.09998C19.51 3.09998 22 5.59998 22 8.68998C22 15.69 15.52 19.82 12.62 20.81Z" stroke="#ef4444" fill="#ef4444" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
            ...
            <div className="grid grid-cols-4 gap-6 mt-6">
              {product?.images.map((img) => (
                <div className="relative pb-[100%] rounded-2xl overflow-hidden border-2 border-slate-400">
                  <img
                    alt=""
              ...
              <div className="relative pb-[100%] rounded-2xl overflow-hidden border-2 border-transparent">
                <img
                  alt=""
                  className="absolute w-full h-full object-cover"
                  src="./img/detail1.webp"
                />
              </div>
            </div>
          </div>
